...
- **Use in Yue:** glosses for character breakdown, and **headword attestation** to verify LLM Cantonese on finals.  
...
- **Status in Yue:** **Not used.** Verification and glosses currently rely on **CC-Canto** + seed.  

    ...
    const system =
      register === 'formal'
        ? [
            ...
            'On the PRIMARY line, ALWAYS mark stress/glottal with dictionary diacritics on every content word (acute/grave/circumflex on the stressed vowel). Alternatives may be unmarked.',
    ...
    const system = toTl
      ? register === 'formal'
        ? [
            ...
            'ALWAYS mark stress/glottal with dictionary diacritics on every content word of the translation (for learner pronunciation).',
            'Do NOT use Chinese characters.',
            'Return ONLY valid JSON:',

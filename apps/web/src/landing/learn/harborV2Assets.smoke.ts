...
assert.match(glbSrc, /alignScoutGlbHipsToSeat/, 'sit plants hip-align to the seat')
assert.match(glbSrc, /HARBOR_CHAIR_HIP_ABOVE_SEAT/, 'chair hips rest on the cushion')
assert.match(glbSrc, /HARBOR_CANOE_HIP_ABOVE_SEAT/, 'canoe hips rest above the deck')

...
function main() {
  ...
  assert.match(guanSrc, /hqGuanGrassTexture|scatterGrassTufts/, 'soft Guan grass + tuft scatter')
  assert.match(guanSrc, /hqGuanSandTexture|hqGuanDirtTexture|hqGuanThatchTexture/, 'Guan soft sand/dirt/thatch')
  ...
  assert.match(craftSrc, /export function hqGuanSandTexture/, 'Guan soft sand texture')
  assert.match(craftSrc, /export function hqGuanGrassTexture/, 'Guan soft grass texture')
  assert.match(craftSrc, /export function hqGuanDirtTexture/, 'Guan soft dirt texture')
  assert.match(craftSrc, /export function hqGuanThatchTexture/, 'Guan soft thatch texture')
  assert.match(craftSrc, /makeSoft128DataTex|LinearFilter/, 'Guan soft textures use linear filter')
  assert.match(craftSrc, /softBlendDisc|softNoise2/, 'Guan soft painterly blotches')

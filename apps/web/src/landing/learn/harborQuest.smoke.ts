...
function main() {
  ...
  assert.ok(playSrc.includes('HarborWornBoard'), 'inventory uses OSRS-style worn board')
  assert.ok(playSrc.includes('Worn equipment'), 'inventory title is Worn equipment')

          ...
          >
            <div className="char-sheet-bar">
              <p id={titleId} className="char-sheet-kicker">
                <BiText copy={ui.charDetail} size="sm" />
              </p>
              <button
                ref={closeRef}
                type="button"
            ...
            {tone && TONE_NAME[tone] ? (
              <section className="char-sheet-block">
                <h3>
                  <BiText copy={ui.tone} size="sm" /> {tone}
                </h3>
                <p>
                  <BiText copy={TONE_NAME[tone]} size="sm" />
                  <span className="char-sheet-sep"> · </span>
                  <BiText copy={TONE_CUE[tone]} size="sm" />
                </p>
                {entering ? (
                  <p className="char-sheet-note">
                    <BiText copy={ui.enteringTone} size="sm" />
                  </p>
                ) : null}
              </section>
            ) : null}
            ...
            {charDef ? (
              <section className="char-sheet-block">
                <h3>
                  <BiText copy={ui.thisCharacter} size="sm" />
                </h3>
                <p>{charDef}</p>
              </section>
            ) : null}
            ...
            {isValidDefinition(detail.definition) ? (
              <section className="char-sheet-block">
                <h3>
                  <BiText copy={ui.inThisPhrase} size="sm" />
                </h3>

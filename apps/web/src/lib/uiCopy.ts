...
export const ui = {
  ...
  creatorsEditorsLead: {
    en: 'Import Noto Sans (and Noto Sans HK for 漢字) in Instagram Reels, CapCut, Canva, or your NLE — Chao tone letters need Noto Sans.',
    zh: '喺 Instagram Reels、CapCut、Canva 或你嘅剪輯軟件匯入 Noto Sans（漢字另加 Noto Sans HK）——趙元任調號需要 Noto Sans。',
  ...
  creatorsIgNote: {
    en: 'Reels can import custom fonts — use Noto Sans so Chao tone letters (˥ ˨˩ …) render correctly.',
    zh: 'Reels 可以匯入自訂字體——用 Noto Sans 先正確顯示趙元任調號（˥ ˨˩ …）。',
  ...
  creatorsIg3: {
    en: 'Paste your Jyutping + Chao string onto the text layer set to Noto Sans. For 漢字, add a second layer with Noto Sans HK if needed.',

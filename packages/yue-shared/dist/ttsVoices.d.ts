...
export declare function resolveSpeakVoice(lang: string, preferredYue?: string | null, preferredEn?: string | null, preferredCmn?: string | null, preferredWuu?: string | null, preferredTl?: string | null, override?: string | null): {
    voice: string;
    xmlLang: string;
};

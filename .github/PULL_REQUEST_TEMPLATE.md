...
- [ ] If STT / mic / TTS changed: tap stays listening (every language) until second tap or ~2s silence after speech; mic tap during auto-speak barges in without killing capture — see `AGENTS.md` Live mic

...
7. **Immersive TTS.** Harbor pier hear chips, arena words, and 港灣 delve clips **always auto-play** via `speakHarborTts` (ducks BGM). Independent of Account Hub **Auto-speak**, which stays a Solo / Conversation Family opt-in (default OFF). SpeakButton remains for replay.

...
3. Activate **Jyut Translator**.
4. Settings → Jyut Translator: paste Azure Speech key/region and OpenAI key.
...
Or set user meta in wp-admin (Users → Profile → Jyut Translator plan).

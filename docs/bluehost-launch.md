...
| --- | --- | --- | --- | --- |
| Guest / 访客 | Blocked (sign-in) / 不可用（需登录） | Free for everyone / 人人免费 | Blocked / 不可用 | Allowed / 可用 |
| Free / 免费 | ~20 min/mo (configurable) / 约每月 20 分钟（可配置） | Free for everyone / 人人免费 | Off / 关闭 | Allowed / 可用 |
| Pro / 专业版 | ~600 min/mo / 约每月 600 分钟 | Free for everyone / 人人免费 | On / 开启 | Allowed / 可用 |

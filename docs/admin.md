...
| Practice Partner | Live admin lab: Harbor orb + captions. Mic → Web Speech STT → DeepSeek (港灣 = HK uncle→nephew persona + chat history) → existing Azure TTS. No Voice Live / Foundry. Not in the consumer app. |

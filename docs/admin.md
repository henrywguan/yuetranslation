...
| Practice Partner | Internal lab only: reactive Harbor orb + live subtitles (simulated). No Voice Live / Foundry (cost). Not shown in the consumer app until publish-ready. |

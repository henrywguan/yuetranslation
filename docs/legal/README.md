...
**Canonical source** for Privacy / Terms (also imported by the web app at build time):

| Document | File | In-app route |
| --- | --- | --- |
...
Footer links (Privacy · Terms · Contact) and auth-panel “agree to Terms and Privacy” are wired.

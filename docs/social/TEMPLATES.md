...
Named recall sheets for JyutTranslate Studio. Prefer **$0 / low-credit** pipelines; ask Henry before paid video.

| Recall phrase | Doc | Best for |
| --- | --- | --- |
...
## Brand locks (all templates)

- Harbor `#07131f` · Jade `#3dcfb6` · Ink `#e8f4ff`
- Logo: **`docs/brand/favicon.png` only**
- Type: **Syne** (hooks) · **Noto Sans** / **Noto Sans HK** (body / 粵)
- Never AI-fake product UI — Recordly / screen capture only
- Cloud agents: confirm Azure / DeepSeek / paid Higgsfield **video** before spend

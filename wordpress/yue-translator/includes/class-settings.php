...
final class Yue_Settings
{
    ...
    public static function defaults(): array
    {
        return [
            ...
            'yue_free_live_minutes' => 60,
            'yue_pro_live_minutes' => 480,
            ...
            <form method="post" action="options.php">
                ...
                <table class="form-table" role="presentation">
                    ...
                    <tr>
                        ...
                        <td><input type="number" min="0" name="yue_free_live_minutes" value="<?php echo esc_attr((string) get_option('yue_free_live_minutes', 60)); ?>" /></td>
                    </tr>
                    <tr>
                        <th>Pro live minutes / month</th>
                        <td><input type="number" min="0" name="yue_pro_live_minutes" value="<?php echo esc_attr((string) get_option('yue_pro_live_minutes', 480)); ?>" /></td>
                    </tr>
                    <tr>

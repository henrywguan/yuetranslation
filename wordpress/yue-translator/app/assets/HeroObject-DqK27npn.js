...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function wa(e,t,n){let r=new Float32Array(ua),i=new q(0,1,0);return new oi({name:`SphericalGaussianBlur`,defines:{n:ua,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:Da(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Ta(){return new oi({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:Da(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Ea(){return new oi({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Da(),fragmentShader:`
	...
	`}var Oa=class extends At{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new Gr(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`)+`
`+_);let y=v+g+o,b=v+_+s,x=Ko(i,i.VERTEX_SHADER,y),S=Ko(i,i.FRAGMENT_SHADER,b);i.attachShader(h,x),i.attachShader(h,S),n.index0AttributeName===void 0?n.hasPositionAttribute===!0&&i.bindAttribLocation(h,0,`position`):i.bindAttribLocation(h,0,n.index0AttributeName),i.linkProgram(h);function C(t){if(e.debug.checkShaderErrors){let n=i.getProgramInfoLog(h)||``,r=i.getShaderInfoLog(x)||``,a=i.getShaderInfoLog(S)||``,o=n.trim(),s=r.trim(),c=a.trim(),l=!0,u=!0;if(i.getProgramParameter(h,i.LINK_STATUS)===!1){if(l=!1,typeof e.debug.onShaderError==`function`)e.debug.onShaderError(i,h,x,S);else{let e=Qo(i,x,`vertex`),n=Qo(i,S,`fragment`);U(`WebGLProgram: Shader Error `+i.getError()+` - VALIDATE_STATUS `+i.getProgramParameter(h,i.VALIDATE_STATUS)+`
...
`;function _c(){let e=(0,a.useRef)(null),t=i(),{theme:n}=r();return(0,a.useEffect)(()=>{let r=e.current;if(!r)return;let i=r.clientWidth,a=r.clientHeight,o=n===`light`,s=new pc({antialias:!0,alpha:!0});s.setPixelRatio(Math.min(window.devicePixelRatio,1.75)),s.setSize(i,a),s.setClearColor(0,0),r.appendChild(s.domElement);let c=new gn,l=new ji(40,i/a,.1,100);l.position.z=5.4;let u=new cn;c.add(u);let d=new X(o?`#1f9f8a`:`#3dcfb6`),f=new X(o?`#0f6b5d`:`#147a6a`),p=new X(o?`#6a93a8`:`#8eb6c9`),m=[],h=[{r:1.25,pos:new q(.35,.05,0),speed:.12},{r:.48,pos:new q(-1.15,.55,.5),speed:.18},{r:.36,pos:new q(1.05,-.5,.6),speed:.22},{r:.22,pos:new q(-.35,-.75,.3),speed:.26}];for(let e of h){let t=new oi({vertexShader:hc,fragmentShader:gc,uniforms:{uJade:{value:d},uDeep:{value:f},uCool:{value:p},uLight:{value:+!!o}},transparent:!0,depthWrite:!1,blending:1}),n=new Nr(new Zr(e.r,64,64),t);n.position.copy(e.pos),u.add(n),m.push(n)}let g=new Zr(1.6,32,32),_=new xr({color:d,transparent:!0,opacity:o?.06:.1,depthWrite:!1}),v=new Nr(g,_);v.position.set(.35,.05,-.8),u.add(v);let y={x:0,y:0},b=e=>{y.x=e.clientX/window.innerWidth*2-1,y.y=e.clientY/window.innerHeight*2-1};t||window.addEventListener(`pointermove`,b);let x=()=>{let e=r.clientWidth,t=r.clientHeight;s.setSize(e,t),l.aspect=e/t,l.updateProjectionMatrix()};window.addEventListener(`resize`,x);let S=0,C=new Ji,w=()=>{let e=C.getElapsedTime();u.rotation.y=e*.08+y.x*.15,u.rotation.x=Math.sin(e*.2)*.08+y.y*.1,m.forEach((t,n)=>{let r=h[n];t.position.y=r.pos.y+Math.sin(e*r.speed*3.5+n)*.06,t.position.x=r.pos.x+Math.cos(e*r.speed*2.8+n)*.04}),s.render(c,l)},T=!0,E=()=>{T&&(w(),S=requestAnimationFrame(E))},D=()=>{document.hidden?(T=!1,cancelAnimationFrame(S)):!t&&!T&&(T=!0,E())};return document.addEventListener(`visibilitychange`,D),t?w():E(),()=>{T=!1,cancelAnimationFrame(S),window.removeEventListener(`resize`,x),window.removeEventListener(`pointermove`,b),document.removeEventListener(`visibilitychange`,D),m.forEach(e=>{e.geometry.dispose(),e.material.dispose()}),g.dispose(),_.dispose(),s.dispose(),s.domElement.parentNode===r&&r.removeChild(s.domElement)}},[t,n]),(0,mc.jsx)(`div`,{ref:e,className:`hero-object`,"aria-hidden":`true`})}export{_c as HeroObject};
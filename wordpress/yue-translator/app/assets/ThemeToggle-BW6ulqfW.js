import{r as e}from"./rolldown-runtime-hePW80VL.js";import{w as t}from"./auth-CbgG5V_1.js";import{F as n,I as r,L as i,M as a,N as o,P as s,x as c}from"./api-2oY9EHbr.js";import{F as l,M as u,O as d,a as f,i as p,o as m,t as h,x as g,y as _}from"./index-Bk7H7tR3.js";var v=i(),y=e(t(),1);function b({children:e,...t}){let i=(0,y.useContext)(s);t={...i,...t},t.transition=n(t.transition,i.transition),t.isStatic=r(()=>t.isStatic);let a=(0,y.useMemo)(()=>t,[JSON.stringify(t.transition),t.transformPagePoint,t.reducedMotion,t.skipAnimations,t.isValidProp]);return(0,v.jsx)(s.Provider,{value:a,children:e})}function x({variant:e=`lockup`,className:t=``,title:n=`JyutTranslate`}){let r=(0,y.useId)().replace(/:/g,``),i=`jyut-jade-${r}`,a=`jyut-shine-${r}`;return e===`mark`?(0,v.jsxs)(`svg`,{className:`jyut-logo jyut-logo--mark ${t}`.trim(),viewBox:`0 0 64 64`,role:`img`,"aria-label":n,children:[(0,v.jsx)(`title`,{children:n}),(0,v.jsxs)(`defs`,{children:[(0,v.jsxs)(`linearGradient`,{id:i,x1:`12`,y1:`8`,x2:`56`,y2:`58`,gradientUnits:`userSpaceOnUse`,children:[(0,v.jsx)(`stop`,{stopColor:`var(--jade-bright)`}),(0,v.jsx)(`stop`,{offset:`0.45`,stopColor:`var(--jade)`}),(0,v.jsx)(`stop`,{offset:`1`,stopColor:`var(--jade-deep)`})]}),(0,v.jsxs)(`radialGradient`,{id:a,cx:`32%`,cy:`26%`,r:`70%`,children:[(0,v.jsx)(`stop`,{stopColor:`rgba(255,255,255,0.42)`}),(0,v.jsx)(`stop`,{offset:`1`,stopColor:`rgba(255,255,255,0)`})]})]}),(0,v.jsx)(`rect`,{width:`64`,height:`64`,rx:`18`,fill:`url(#${i})`}),(0,v.jsx)(`rect`,{width:`64`,height:`64`,rx:`18`,fill:`url(#${a})`}),(0,v.jsx)(`text`,{className:`jyut-logo-mark-j`,x:`10`,y:`50`,fontSize:`46`,children:`J`}),(0,v.jsx)(`text`,{className:`jyut-logo-yue jyut-logo-yue--on-jade`,x:`38`,y:`41`,textAnchor:`middle`,fontSize:`18`,children:`粵`})]}):(0,v.jsxs)(`svg`,{className:`jyut-logo jyut-logo--lockup ${t}`.trim(),viewBox:`0 0 340 56`,role:`img`,"aria-label":n,children:[(0,v.jsx)(`title`,{children:n}),(0,v.jsx)(`defs`,{children:(0,v.jsxs)(`linearGradient`,{id:i,x1:`8`,y1:`6`,x2:`40`,y2:`44`,gradientUnits:`userSpaceOnUse`,children:[(0,v.jsx)(`stop`,{stopColor:`var(--jade-bright)`}),(0,v.jsx)(`stop`,{offset:`0.5`,stopColor:`var(--jade)`}),(0,v.jsx)(`stop`,{offset:`1`,stopColor:`var(--jade-deep)`})]})}),(0,v.jsx)(`text`,{className:`jyut-logo-latin`,x:`0`,y:`42`,fontSize:`36`,children:`J`}),(0,v.jsx)(`text`,{className:`jyut-logo-yue`,x:`14`,y:`30`,textAnchor:`middle`,fontSize:`14`,fill:`url(#${i})`,children:`粵`}),(0,v.jsx)(`text`,{className:`jyut-logo-latin`,x:`28`,y:`42`,fontSize:`36`,children:`yutTranslate`})]})}var S=`
...
vec3 sceneColor(vec2 uv, float t, float light) {
...
// Spherical env look-up for reflections (jade/harbor studio lighting)
...
vec4 refractOrb(vec2 uv, vec2 c, float rad, float depth, float light, float t, float ior) {
  ...
  // Real refraction through glass (eta = air/glass)
  float eta = 1.0 / ior;
  vec3 refrDir = refract(-view, n, eta);
  // Fallback if TIR
  if (dot(refrDir, refrDir) < 0.001) {
    refrDir = reflect(-view, n);
  }

  // Optical thickness — stronger center magnification (precious lens)
  ...
  // Slight brightness lift in the lens core (magnified light)
  refracted *= 1.0 + 0.12 * z;

  // Reflection (fresnel)
  vec3 reflDir = reflect(-view, n);
  vec3 reflected = envReflect(reflDir, light);

  float cosTheta = max(dot(n, view), 0.0);
  float fres = pow(1.0 - cosTheta, 3.2);
  fres = mix(0.04, 1.0, fres); // Schlick-ish floor

  vec3 col = mix(refracted, reflected, fres);

  // Crescent specular (studio catchlight)
...
void main() {
  ...
  vec3 col = sceneColor(uv, t, light);

  // Far haze orbs (no refraction — depth cue)
  for (int j = 0; j < 3; j++) {
    float fj = float(j);
    vec2 c = vec2(
      sin(t * 0.28 + fj * 1.8) * 1.0,
      cos(t * 0.22 + fj * 2.0) * 0.55
    );
  ...
  vec4 o1 = refractOrb(uv, vec2(-0.52 + 0.025 * cos(t * 0.3), 0.30), 0.32, 0.35, light, t, 1.40);
  col = mix(col, o1.rgb, o1.a);
...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function oo(e,t,n){let r=new Float32Array(Ka),i=new q(0,1,0);return new Ui({name:`SphericalGaussianBlur`,defines:{n:Ka,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:lo(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function so(){return new Ui({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:lo(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function co(){return new Ui({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:lo(),fragmentShader:`
	...
	`}var uo=class extends Xt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new Oi(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
